...
-- CreateIndex
CREATE UNIQUE INDEX "ChatRoom_communityId_name_key" ON "ChatRoom"("communityId", "name");
...
-- AddForeignKey
ALTER TABLE "ChatRoom" ADD CONSTRAINT "ChatRoom_communityId_fkey" FOREIGN KEY ("communityId") REFERENCES "Community"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DirectMessage" ADD CONSTRAINT "DirectMessage_connectionId_fkey" FOREIGN KEY ("connectionId") REFERENCES "ConnectionRequest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
